...
from openstack_dashboard import local
...
if LOGIN_REDIRECT_URL is None:
    LOGIN_REDIRECT_URL = WEBROOT + 'auth/otp/'
if LOGIN_OTP_REDIRECT_URL  is None:
    LOGIN_OTP_REDIRECT_URL = WEBROOT
